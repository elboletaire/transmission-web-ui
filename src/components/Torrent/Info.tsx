        ...
        torrent.percentDone === 1
          ? (
              <Text fontSize='xs'>
                ...
                uploaded {prettyBytes(torrent.uploadedEver)} (ratio {torrent.uploadRatio})&nbsp;
                - <TimeLeft />
              </Text>
            )
          : (
...
export const Uploading = () => {
  ...
  return <Text>Seeding to {torrent.peersGettingFromUs} of {torrent.peersConnected} peers</Text>
}
...
export const SpeedInfo = () => {
  ...
  return (
    <Stack direction='row'>
      <Text><Icon as={AiFillCaretDown} /> {prettyBytes(torrent.rateDownload)}/s</Text>
      <Text><Icon as={AiFillCaretUp} /> {prettyBytes(torrent.rateUpload)}/s</Text>
    </Stack>
  )
}
